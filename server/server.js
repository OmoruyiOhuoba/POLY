...
AWS.config.loadFromPath('/Users/omoruyiohuoba/Desktop/APPS/WEB DEVELOPMENT/poly/server/.config.json')
AWS.config.region = process.env.AWS_DEFAULT_REGION
AWS.config.credentials = new AWS.Credentials(process.env.AWS_ACCES_KEY_ID, process.env.AWS_SECRET_ACCESS_KEY, process.env.AWS_REGION)
